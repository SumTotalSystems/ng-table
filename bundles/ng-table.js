...
function ngTable($q, $parse) {
    return {
        ...
        compile: function (element) {
            ...
            // Accessibility: caters for both <td> and <th> in rows of <tbody>
            ng1.forEach(dataRow.find('th'), function (item) {
